...
// 3D Hologram Profile Disc & Cyber Rings Component
function HologramAvatarMesh() {
  ...
  return (
    <group ref={meshGroup}>
      ...
      {/* Secondary Orbiting Electric Blue Ring */}
...
export function HologramAvatarCanvas({ className = "w-full h-full min-h-[320px]" }) {
  return (
    <div className={className} style={{ position: 'relative', width: '100%', height: '100%', minHeight: '320px' }}>
      ...
      >
        ...
        {/* Floating Hologram Pod */}
        <Float speed={2} rotationIntensity={0.2} floatIntensity={0.5}>
          <HologramAvatarMesh />
        </Float>

        {/* Ambient Cyan & Blue Hologram Particles */}
        <Sparkles 
          count={60} 
          scale={4} 
          size={3} 
